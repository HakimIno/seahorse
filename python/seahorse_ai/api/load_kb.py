...
Usage::
    ...
    uv run python -m seahorse_ai.api.load_kb knowledge/
    ...
    uv run python -m seahorse_ai.api.load_kb knowledge/ --save snapshot.bin
...
async def main(source: Path) -> int:
    from seahorse_ai.engines.knowledge import KnowledgeBase
    from seahorse_ai.engines.rag.rag import RAGPipeline
